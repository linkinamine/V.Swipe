...
//        view = new RelativeLayout(this);
        ...
        authURLString = AUTHURL + "?client_id=" + client_id + "&redirect_uri=" + CALLBACKURL + "&response_type=code&display=touch&scope=basic+public_content+likes+relationships";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String tokenURLStringFollow = "https://api.instagram.com/v1/users/self/follows/?access_token=" + accessTokenString;

                    URL url = new URL(tokenURLStringFollow);
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                cancelDialog();
                Log.i("json follow ", jsonObject.toString());
                Log.i("access token : ", accessTokenString);
                finish();
            }
        }.execute();
...
//                                    "&code=" + token);
                            ...
                            profile_picture = jsonObject.getJSONObject("user").getString("profile_picture").replace("s150x150", "s640x640");
